    ...
    <div className='w-full mt-24 bg-slate-900 text-gray-300 py-4 px-2'>
        <div className='max-w-[1240px] mx-auto grid grid-cols-2 md:grid-cols-6 border-b-2 border-gray-600 py-8'>
            ...
            <div className='col-span-2 pt-8 md:pt-2'>
                ...
                <p className='py-4'>The lastest new, articles, and resources, sent to your inbox weekly.</p>
                <form className='flex flex-col sm:flex-row'>
                    <input className='w-full mr-4 p-2 rounded-md mb-4' type="email" placeholder='Enter email' />
